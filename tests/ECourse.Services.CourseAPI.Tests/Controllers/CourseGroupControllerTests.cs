...
{
    public class CourseGroupControllerTests : IClassFixture<ECourseWebApplicationFactory>
    {
        private readonly HttpClient _httpClient;
        private readonly IMongoCollection<CourseGroup> _collection;
        private readonly string ApiUrl = "/api/CourseGroup"; 

        public CourseGroupControllerTests(ECourseWebApplicationFactory factory)
        {
            _httpClient = factory.CreateClient();
            var dbContext = factory.Services.GetRequiredService<ApplicationDbContext>();
            _collection = dbContext.GetCollection<CourseGroup>(CourseGroup.DocumentName);
        }
        [Fact]
