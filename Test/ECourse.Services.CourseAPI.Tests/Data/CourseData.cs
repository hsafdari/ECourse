...
{
    public class CourseData : IFakeData<Course, CourseDto>
    {
        public Course FakeGetSingleRow()
        {
            ...
            ObjectId TeacherId = MongoDB.Bson.ObjectId.GenerateNewId();
            var teacher = new Teacher()
            {
                Id = TeacherId,
                FirstName = "Teacher Test name",
                LastName = "Techer LastName Test"
            };
                ...
                Prices = new List<Models.CoursePrice>()
    {
         ...
         new Models.CoursePrice(){
                ...
                Teachers = new List<Models.CourseTeacher>()
    {
        new Models.CourseTeacher()
        {
            CourseId=courserId,
        ...
        public CourseDto FakeGetSingleRowDTO()
        {
